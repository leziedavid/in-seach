...
import { ServiceStats } from "@/types/interface"

export default function ServicePerformance({ stats }: { stats: ServiceStats | null }) {
    const tiles = [
        {
    ...
    return (
        <>
            <div className="flex items-center gap-2 mb-4">
                <h3 className="text-lg font-black text-foreground">Performances de mes services</h3>
            </div>
