...
export default function CategoryServiceForm({ initialData, onSubmit, isSubmitting, isEditing = false, onClose }: CategoryServiceFormProps) {
                ...
                <div className="bg-card rounded-xl border border-border p-4 space-y-4">
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="ex: Plomberie, Informatique..."
                        />
