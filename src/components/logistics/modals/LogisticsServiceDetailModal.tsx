                            ...
                            <div className="flex-1 overflow-y-auto">
                                <div className="grid md:grid-cols-2 gap-0 md:gap-6">
                                    ...
                                    <div className="relative aspect-square md:aspect-auto md:h-full bg-muted min-h-[300px]">
                                        ...
                                        <button onClick={onClose} className="absolute top-4 left-4 flex h-10 w-10 items-center justify-center rounded-full bg-[#F2EFE7] text-[#0F2944] hover:bg-[#E8E2D6] transition-all active:scale-90">
