...
export default function DeliveryAssignmentModal({ isOpen, delivery, onClose, onSuccess }: DeliveryAssignmentModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#0F2944]/30 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-[#FBFAF6] text-[#0F2944] border border-[#EEF1F4] w-xl max-w-2xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(15,41,68,0.13)] overflow-visible animate-in zoom-in-95 duration-300">
