...
import { StoreStats } from "@/types/interface"

export default function StorePerformance({ stats }: { stats: StoreStats | null }) {
    const tiles = [
        {
        ...
        },
        {
            ...
            label: "Produits boostés",
            value: stats ? stats.boostedProductsCount : "—",
        },
    ];
    ...
    return (
        <>
            <div className="flex items-center gap-2 mb-4">
                <h3 className="text-lg font-black text-foreground">Performances de ma boutique</h3>
            </div>
