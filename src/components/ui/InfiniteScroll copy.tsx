        ...
        <div ref={containerRef} className={`w-full ${className} transition-all duration-500`}>
            ...
            {startIndex > 0 && (
                <div className="w-full flex justify-center py-6">
                    <button onClick={() => setStartIndex(Math.max(0, startIndex - batchSize))} className="group flex flex-col items-center gap-2 transition-all hover:scale-105 active:scale-95">
