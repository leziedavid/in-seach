                ...
                <div className="flex flex-col md:flex-row gap-4 items-center">
                    <div className="flex-1 w-full bg-white rounded-2xl flex items-center px-5 py-3 border border-slate-100 focus-within:border-primary focus-within:shadow-lg focus-within:shadow-primary/5 transition-all">
                        ...
                        <input
                            ...
                            className="bg-transparent outline-none w-full font-medium text-slate-700 text-sm md:text-base"
                            value={query}
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        <button
                            ...
                            className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 rounded-2xl font-bold transition-all shadow-sm ${lat ? 'bg-primary text-white' : 'bg-white text-slate-600 border border-slate-100 hover:bg-slate-50'}`}>
